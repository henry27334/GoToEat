...
$sql = "SELECT DISTINCT product_size.product_size, singleplus_1.name AS single1_name, singleplus_2.name as single2_name, singleplus_3.name as singleplus3_name, order_detail.detail_price, order_detail.detail_quantity, multipleplus.name, customized_plus.plus_quantity
FROM drink_order 
...
if($rowNum > 0){
	...
	echo "Error: No drink comment info.";
}
